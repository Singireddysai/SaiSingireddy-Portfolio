  ...
  return (
    <div>
      <Drawer>
        ...
        <FramerMagnetic>
          <DrawerTrigger className="cursor-pointer group connect flex items-center gap-1 p-2 rounded-full">
        ...
        <DrawerContent className="border contact-drawer border-neutral-700 text-white rounded-t-xl mx-auto max-w-2xl">
